...
use App\Livewire\Finnernce\createfinnence;
...
use App\Livewire\Teacher\createAllteacher;
...
Route::middleware(['auth'])->group(function (){
    ...
    Route::get('/manage-new-teachers',createAllteacher::class)->name('teachers.all');
    ...
    route::get('/manage-create-payments',createfinnence::class)->name('payments.create');
